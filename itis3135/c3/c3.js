...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function setupRandomGalleryPhoto() {
    ...
    // Simple list of photos to rotate through
    var photos = [
      {
        src: "when-sunrise.jpg",
        text: "Early morning lineup before a campus cruise."
      },
      {
        src: "where-spot.jpg",
        text: "Our go-to photo spot just off campus."
      },
      {
        src: "who-community.jpg",
      ...
      {
        src: "IMG_5973.JPG",
        text: "Detail from one of our members’ builds."
      }
    ];
